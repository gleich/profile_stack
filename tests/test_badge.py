...
def test_technology():
    ...
    assert badged_result == '[![Dart](https://img.shields.io/static/v1?message=Dart&color=52C0F2&logo=dart&logoColor=white)](https://dart.dev/)'
...
def test_project():
    ...
    assert badged_result == '[![import_sorter](https://img.shields.io/static/v1?message=import_sorter&color=000605&logo=github&logoColor=white&labelColor=000605)](https://github.com/fluttercommunity/import_sorter)'

    os.environ['INPUT_BADGES'] = 'false'
    plain_result = badge.project(project_url)
    assert plain_result == '[import_sorter](https://github.com/fluttercommunity/import_sorter)'
